...
public class SendLMSTagPOST{
	...
	final String type="/tag-sender/mms";

	//requestbody Creation
	JSONObject requestBody=new JSONObject();
	requestBody.put("title", "tag Test");	
	requestBody.put("body", "태그 테스트");
	requestBody.put("sendNo", "01041002071");	
	...
	recipientList.put("recipientNo", "01041002071");
